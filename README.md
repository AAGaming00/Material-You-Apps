...
#### 2. Have Material you (dynamic colouring, **_Required_**)
#### 3. Have Material 3 design (_**Optional, Not Required**_)
...
#### [Pix Wallpapers](https://play.google.com/store/apps/details?id=com.pashapuma.pix.wallpapers) <sup>`🧉 Google Play Store`</sup>
...
#### `☕` `🧋` [MiXplorer](https://forum.xda-developers.com/t/app-2-2-mixplorer-v6-x-released-fully-featured-file-manager.1523691/) <sup>`🧉 XDA`</sup> <sup>[`MiXplorer Material You tutorial!`](https://github.com/TeaEndsAcronyms/Material-You-Apps/releases/tag/3.5)</sup>
...
#### Use [Stack For Stack OverFlow](https://play.google.com/store/apps/details?id=me.tylerbwong.stack) <sup>`🧉 Google Play Store`</sup>
...
#### `☕` `🥤` [VLC Media Player](https://t.me/waifupx_official/233) <sup>`🧉 Telegram`</sup>
...
#### `🧋` `🍵` [DarQ](https://github.com/KieronQuinn/DarQ) <sup>`🧉 Github`</sup>
...
#### `🧋` [Simple Password](https://github.com/grigorevmp/Simple_Passwords_QuickPass) <sup>`🧉 Github`</sup>
